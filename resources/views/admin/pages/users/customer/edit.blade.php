                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <form action="{{ route('customer.update', $customer_edit->id) }}"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                    name="name" value="{{ $customer_edit->name }}">
                                            </div>
                                            @error('name')
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control @error('email') is-invalid @enderror"
                                                    name="field_1" value="{{ $customer_edit->field_1 }}">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="field_2" value="{{ $customer_edit->field_1 }}">
