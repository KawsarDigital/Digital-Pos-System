    ...
    <div class="app-inner-bar">
        ...
        <div class="">
            <div class="btn-actions-pane-right">
                <a type="button" href="{{ route('userList.create') }}"
                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                            ...
                                            <tbody>
                                                @foreach ($userList as $item)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <form action="{{ route('userList.destroy', $item->id) }}"
                                                                method="POST">
                                                                <a href="{{ route('userList.edit', $item->id) }}">
                                        ...
                                        @include('admin.partials.paginate',['style' => 'rounded', 'data' => $userList,])
                                    </div>
                                </div>
                            </div>
                        </div>
